...
resourcestring
  ...
  *)
  ...
  SYNS_AttrProcedureHeaderParam    = 'Procedure header param name';
...
const
  ...
  *)
  ...
  SYNS_XML_AttrProcedureHeaderParam    = 'Procedure header param name';
  SYNS_XML_AttrProcedureHeaderResult   = 'Procedure header result';
  SYNS_XML_AttrProcedureHeaderType     = 'Procedure header type';
  SYNS_XML_AttrProcedureHeaderValue    = 'Procedure header value';
  SYNS_XML_AttrDeclarationVarConstName = 'Declaration block Var Conts name';
